...
import com.psl.ordermodule20.databinding.ActivityUrlconfigBinding;
...
//                            try {
//                                parseJson(new JSONObject(AssetUtils.getJsonFromAssets(context,"loginres.json")),new JSONObject(AssetUtils.getJsonFromAssets(context,"loginreq.json")),new String(HOST_URL));
//                            } catch (JSONException e) {
//                                e.printStackTrace();
...
//                        }else{
    ...
    public  void showCustomSuccessDialog(Context context, String msg){
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                Intent intent = new Intent(URLConfigActivity.this, LoginActivity.class);
